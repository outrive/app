...
4. Default launch profile: Instant Launch, gas-only, anti-sniper ON for 1 minute (60 seconds). Anti-sniper sets buy tax at 99% decaying linearly to 1% over the window. To disable, the user must explicitly say "no anti-sniper" or "anti-sniper off". Custom window allowed up to 98 minutes. One wallet signature is required.
